<html>
    ...
    <body>
        <table>
            <form name="GeneraContrasenya" action="generaContrasenyaVariasFuncion.php" method="POST">
                <b>Genera Contraseñas Varias</b><p/>
                
                <tr><td>Nº de contraseñas</td> <td><input type="text" name="NumContraseñas" value="" size="20" /></td></tr>
